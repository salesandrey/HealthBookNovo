...
class DropDownTypeProductWidget extends StatelessWidget {

  final String currentSelection;
  final Function changeType;

  final List<String> items = ["Manipulado","Industrializado (Farmácia)"];

  DropDownTypeProductWidget({Key key, this.currentSelection, this.changeType}) : super(key: key);
      ...
      child: Row(
        ...
        children: <Widget>[
          Row(
            ...
            children: [
              ImageIcon(AssetImage("assets/images/icons/pharmacy.png"),color: Colors.grey,),
              SizedBox(width: 10),
              Text(
                currentSelection,
